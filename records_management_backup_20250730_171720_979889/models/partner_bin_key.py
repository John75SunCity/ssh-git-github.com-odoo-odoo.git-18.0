...
class PartnerBinKey(models.Model):
    ...
    binding_model_id = fields.Many2one('binding.model', string='Binding Model Id')
    binding_view_types = fields.Char(string='Binding View Types')
    button_box = fields.Char(string='Button Box')
    category_id = fields.Many2one('category', string='Category Id')
    charge_amount = fields.Float(string='Charge Amount', digits=(12, 2))
    context = fields.Char(string='Context')
    country_id = fields.Many2one('country', string='Country Id')

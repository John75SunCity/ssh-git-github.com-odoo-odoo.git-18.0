...
class MobileBinKeyWizard(models.Model):
    ...
    contact_id = fields.Many2one('contact', string='Contact Id')
    ...
    customer_company_id = fields.Many2one('customer.company', string='Customer Company Id')
    ...
    model_id = fields.Many2one('model', string='Model Id')

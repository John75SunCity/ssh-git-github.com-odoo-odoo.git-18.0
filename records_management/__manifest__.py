...
""",
    ...
    "data/destruction_certificate_number_sequence_data.xml",
    ...
    # ------------------------------------------------------------------
    # Wizard Views (all wizard actions must load before any menus)
    # ------------------------------------------------------------------
    "views/field_label_helper_wizard_views.xml",  # Field Label Helper
    # Report window actions (must load before menus adding them)
    ...
    # ------------------------------------------------------------------
    # Menus (after all wizard/action definitions)
    # ------------------------------------------------------------------
    ...
    # (wizard moved earlier) "views/bin_issue_report_wizard_views.xml",
    ...
    # (wizard moved earlier) "views/paper_bale_inspection_wizard_views.xml",
    ...
    # (wizard moved earlier) "views/paper_bale_weigh_wizard_views.xml",
    ...
    # (wizard moved earlier) "views/records_document_flag_permanent_wizard_views.xml",
    ...
    # (wizard moved earlier) "views/records_location_report_wizard_views.xml",
        "views/records_location_views.xml",
        "views/records_management_bale_views.xml",
    # (wizard moved earlier) "views/records_permanent_flag_wizard_views.xml",
    ...
    # (wizard moved earlier) "views/records_user_invitation_wizard_views.xml",
    ...
    # (wizard moved earlier) "views/shredding_bin_barcode_wizard_views.xml",
    ...
    # (wizard moved earlier) "views/system_flowchart_wizard_views.xml",
        "views/temp_inventory_views.xml",
    # (wizard moved earlier) "views/visitor_pos_wizard_views.xml",

{
    ...
    "data": [
        ...
        "#AdditionalCoreActionsviews/records_container_type_views.xml",
        "#AdditionalCriticalActions(missingfrommanifest)views/records_digital_scan_views.xml",
        "#AdditionalCriticalViewsviews/records_deletion_request_views.xml",
        "#BillingActionsviews/records_billing_config_views.xml",
        "#ComplianceActionsviews/naid_compliance_views.xml",
        "#ConfigurationActionsviews/rm_module_configurator_views.xml",
        "#CoreRecordsManagementActions(mustloadbeforemenus)views/records_container_views.xml",
        "#Existingfilescontinue...views/advanced_billing_line_views.xml",
        "#InventoryActionsviews/customer_inventory_views.xml",
        "#InventoryandLocationViewsviews/inventory_item_views.xml",
        "#MoreCriticalActionsviews/records_storage_box_views.xml",
        "#PortalandCustomerActionsviews/portal_request_views.xml",
        "#PortalandCustomerViewsviews/customer_portal_diagram_views.xml",
        "#ReportActionsviews/revenue_forecaster_views.xml",
        "#ServiceandOperationsViewsviews/shredding_service_log_views.xml",
        "#ServiceOperationsActionsviews/pickup_request_views.xml",

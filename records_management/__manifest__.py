# -*- coding: utf-8 -*-
{
    ...
    "data": [
        ...
        "views/view_records_billing_config_audit_menus.xml",
    ...
    'data': [
        ...
        'views/fsm_reschedule_wizard_placeholder_views.xml',
        'views/fsm_reschedule_wizard_views.xml',
        'views/fsm_route_management_views.xml',
        ...
        'views/records_billing_config_line_views.xml',
        'views/records_billing_config_views.xml',
        'views/records_billing_consolidated_views.xml',
        'views/records_billing_line_views.xml',
        'views/records_billing_profile_views.xml',
        'views/records_billing_views.xml',
        'views/records_bulk_user_import_views.xml',

...
class ResPartner(models.Model):
    ...
    total_monthly_revenue = fields.Float(string="Total Monthly Revenue", default=0.0,,
    help="Total monthly revenue from this customer"),
    billing_account_number = fields.Char(string="Billing Account Number",,
    help="Billing account number"),
    preferred_pickup_day = fields.Char(string="Preferred Pickup Day",,
    help="Preferred day for pickups"):
    ...
    active_bin_key_count = fields.Integer(string="Active Bin Keys",,
    compute="_compute_active_bin_key_count"),
    emergency_contact = fields.Char(string="Emergency Contact"),
    has_bin_key = fields.Boolean(string="Has Bin Key",,
    ...
    total_unlock_charges = fields.Monetary(string="Total Unlock Charges", currency_field="currency_id",,

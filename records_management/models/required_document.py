...
class RequiredDocument(models.Model):
    ...
    pos_wizard_id = fields.Many2one('visitor.pos.wizard', string='POS Wizard', required=True, ondelete='cascade')
    ...
    is_provided = fields.Boolean(string='Provided', tracking=True)

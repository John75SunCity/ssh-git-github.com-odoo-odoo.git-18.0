...
class PortalBarcode(models.Model):
    ...
    _portal_barcode_name_unique = models.Constraint('unique(name, company_id)', _('Barcode already exists for this company.'))
    ...
    def generate_portal_barcode(self, barcode_type='generic', barcode_format='code128'):
        ...
        Keeps minimal surface – more complex association logic can be layered later.
        """

...
class ShreddingService(models.Model):
    ...
    # ==========================================
    name = fields.Char(string='Service Number', required=True, tracking=True, 
    ...
    actual_completion_time = fields.Datetime(string='Actual Completion Time', tracking=True)
    estimated_duration = fields.Float(string='Estimated Duration (Hours)', 
                                     default=2.0, tracking=True)
    ...
    ], string='Service Type', default='onsite', required=True, tracking=True)
    ...
    box_ids = fields.Many2many('records.box', string='Boxes to Destroy', 
                              tracking=True)
    document_ids = fields.Many2many('records.document', string='Documents to Destroy',
                                   tracking=True)
    ...
    # ==========================================
    destruction_photographed = fields.Boolean(string='Destruction Photographed', 
                                             tracking=True)
    ...
    # ==========================================
    certificate_generated = fields.Boolean(string='Certificate Generated', 
                                          tracking=True)

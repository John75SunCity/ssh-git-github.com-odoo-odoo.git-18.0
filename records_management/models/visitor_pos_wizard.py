...
class VisitorPosWizard(models.TransientModel):
    ...
    # ============================================================================
    name = fields.Char(string="Visitor Name", required=True, help="Name of the visitor")
    ...
    quantity = fields.Float(string="Quantity", default=1.0, help="Service quantity")
    subtotal = fields.Monetary(
        string="Subtotal", currency_field="currency_id", help="Subtotal before tax"
    )
    tax_id = fields.Many2one("account.tax", string="Tax", help="Applied tax")
    tax_amount = fields.Monetary(
        string="Tax Amount", currency_field="currency_id", help="Tax amount"
    )
    discount_percent = fields.Float(
        string="Discount Percentage", digits=(5, 2), help="Discount percentage"
    )
    ...
    audit_notes = fields.Text(string="Audit Notes", help="Audit-related notes")
    ...
    step_time = fields.Datetime(string="Step Time", help="Time for current step")
    ...
    document_name = fields.Char(string="Document Name", help="Name of document")
    ...
    error_message = fields.Char(string="Error Message", help="Error message details")
    error_details = fields.Text(
        string="Error Details", help="Detailed error information"
    )
    error_time = fields.Datetime(string="Error Time", help="When error occurred")
    ...
    # ============================================================================
    notes = fields.Text(string="Additional Notes", help="Additional notes and comments")
    step_description = fields.Text(
        string="Step Description", help="Description of current step"
    )
    step_name = fields.Char(string="Step Name", help="Name of current step")
    ...
    def action_create_pos_order(self):
        ...
        # Create POS order logic would go here
        self.write(
            {

...
class ShreddingServiceLog(models.Model):
    ...
    notes = fields.Text(string="Notes", help="Additional notes about this activity")
    ...
    efficiency_score = fields.Float(string="Efficiency Score", compute="_compute_efficiency_score", store=True, help="Calculated efficiency based on time and volume")

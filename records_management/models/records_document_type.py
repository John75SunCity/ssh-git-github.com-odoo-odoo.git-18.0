...
class RecordsDocumentType(models.Model):
    ...
    # ============================================================================
    # FIELDS - Additional Unique Fields (Consolidated from Duplicates)
    # ============================================================================
    ...
    audit_log_ids = fields.One2many(comodel_name='records.audit.log', inverse_name='document_type_id', string='Audit Log')

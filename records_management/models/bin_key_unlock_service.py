...
class BinKeyUnlockService(models.Model):
    ...
    access_history_count = fields.Integer(string='Access History Count', compute='_compute_access_history_count', store=True)
    access_level_required = fields.Boolean(string='Access Level Required', default=False)
    ...
    compliance_officer_id = fields.Many2one('compliance.officer', string='Compliance Officer Id')
    ...
    identity_verified = fields.Boolean(string='Identity Verified', default=False)
    ...
    service_rate = fields.Float(string='Service Rate', digits=(12, 2))
    ...
    witness_id = fields.Many2one('witness', string='Witness Id')

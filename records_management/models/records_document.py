...
class RecordsDocument(models.Model):
    ...
    default=False)
        ...
        # Added by Safe Business Fields Fixer
    digital_scan_ids = fields.One2many("records.digital.scan", "document_id",,
    string="Digital Scans")

        # Added by Safe Business Fields Fixer
    chain_of_custody_ids = fields.One2many("records.chain.of.custody", "document_id",,
    string="Chain of Custody")

        # Added by Safe Business Fields Fixer
    audit_trail_ids = fields.One2many("naid.audit.log", "document_id",,
    string="Audit Trail")
    ...
    string="Destruction Authorized By")
    ...
    audit_trail_count = fields.Integer(string='Audit Trail Count', compute='_compute_audit_trail_count',,
    store=True),
    button_box = fields.Char(string='Button Box'),
    card = fields.Char(string='Card'),
    chain_of_custody_count = fields.Integer(string='Chain Of Custody Count', compute='_compute_chain_of_custody_count',,
    store=True),
    ...
    string='Destruction Certificate Id'),

...
class TransitoryFieldConfig(models.Model):
    ...
    show_destruction_date = fields.Boolean(string='Show Destruction Date', default=False)
    show_record_type = fields.Boolean(string='Show Record Type', default=True)
    show_confidentiality = fields.Boolean(string='Show Confidentiality Level', default=False)
    ...
    require_confidentiality = fields.Boolean(string='Require Confidentiality Level', default=False)
    ...
    ], string='Configuration Preset', default='basic')

    # ==========================================
    # COMPUTED FIELDS
    # ==========================================
    visible_field_count = fields.Integer(string='Visible Fields', 

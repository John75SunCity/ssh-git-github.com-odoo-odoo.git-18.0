...
class PaperBaleRecycling(models.Model):
    ...
    # ============================================================================
    status = fields.Selection([('weighed', 'Weighed')
    ...
    white_paper = fields.Char(string='White Paper'), ('inspected', 'Inspected'), ('loaded', 'Loaded'), ('shipped', 'Shipped'), ('sold', 'Sold')], string='Status')

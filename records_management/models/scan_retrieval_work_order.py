...
class ScanRetrievalWorkOrder(models.Model):
    ...
    # SCAN ITEMS & METRICS
    # ============================================================================
    scan_item_ids = fields.One2many('scan.item', 'work_order_id', string="Items to Scan")
    ...
    digital_asset_ids = fields.One2many('scan.digital.asset', 'work_order_id', string="Digital Assets")

...
class ScanRetrievalWorkOrder(models.Model):
    ...
    ], string='Scan Resolution', default='300', required=True,
    ...
    color_mode = fields.Selection([
        ...
        ('grayscale', 'Grayscale'),
        ('color', 'Full Color'),
    ], string='Color Mode', default='color', required=True,
    ...
    ], string='File Naming Convention', default='sequential',

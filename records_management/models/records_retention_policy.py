...
""
    ...
    digits=(5,2), compute="_compute_compliance_rate")
        # ============================================================================
    # COMPUTE METHODS
        # ============================================================================
    # ============================================================================
    ...
    help='When policy was last reviewed'),
    version_date = fields.Date(string='Version Date',,
    help='Date this version was created'),
    version_history_ids = fields.One2many('records.policy.version', 'policy_id',,
    string='Version History'),"
    version_number = fields.Integer(string='Version Number',,""
    help='Sequential version number'),""

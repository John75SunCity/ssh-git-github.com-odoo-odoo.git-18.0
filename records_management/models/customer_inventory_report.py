...
class CustomerInventoryReport(models.Model):
    ...
    index=True),
    report_number = fields.Char(string="Report Number",,
    index=True),
    ...
    include_inactive = fields.Boolean(string="Include Inactive Items",,
    default=False),
    include_destroyed = fields.Boolean(string="Include Destroyed Items",,
    default=False)

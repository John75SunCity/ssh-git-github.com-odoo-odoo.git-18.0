...
class InventoryItemLocationTransfer(models.Model):
    ...
    from_location_id = fields.Many2one(comodel_name='records.location', string='From Location', required=True)
    to_location_id = fields.Many2one(comodel_name='records.location', string='To Location', required=True)

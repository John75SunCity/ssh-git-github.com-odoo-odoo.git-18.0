...
class MobileBinKeyWizard(models.TransientModel):
    ...
    ], string="Action Type", default="unlock", required=True,
    ...
    priority = fields.Selection([
        ...
        ('high', 'High'),
        ('urgent', 'Urgent')
    ], string="Priority", default='normal', help="Operation priority level")
    ...
    ], string="Operation Reason", help="Reason for bin access")
    ...
    mobile_view_mode = fields.Selection([
        ...
        ('expert', 'Expert Mode')
    ], string="Mobile View Mode", default='simple')
    ...
    ], string="Operation Status", default='pending')

...
class TempInventory(models.Model):
    ...
    description = fields.Text(
        string="Description",
        help="Detailed description of temporary inventory",
    ...
    approved_by_id = fields.Many2one(
        "res.users",
        string="Approved By",
        help="User who approved this inventory",
    ...
    view_mode = fields.Char(string='View Mode'), ("out", "Outgoing"), ("transfer", "Transfer")
        # ============================================================================
    # COMPUTE METHODS
        # ============================================================================

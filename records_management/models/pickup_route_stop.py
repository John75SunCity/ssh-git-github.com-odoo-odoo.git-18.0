...
class PickupRouteStop(models.Model):
    ...
    actual_time = fields.Float(string='Actual Time', digits=(12, 2))
    ...
    pickup_route_id = fields.Many2one('pickup.route', string='Pickup Route Id')
    res_model = fields.Char(string='Res Model')
    scheduled_date = fields.Date(string='Scheduled Date')
    scheduled_month = fields.Char(string='Scheduled Month')
    scheduled_time = fields.Float(string='Scheduled Time', digits=(12, 2))
    ...
    state_id = fields.Many2one('state', string='State Id')

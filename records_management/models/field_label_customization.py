...
class FieldLabelCustomization(models.Model):
    ...
    description = fields.Text(string='Description',
                             help="Description of this customization set")
    ...
    label_date_from = fields.Char(string='Date From Label', default='Date From',
                                 help="Custom label for start date")
    label_date_to = fields.Char(string='Date To Label', default='Date To',
                               help="Custom label for end date")
    label_sequence_from = fields.Char(string='Sequence From Label', default='Sequence From',
                                     help="Custom label for sequence start")
    label_sequence_to = fields.Char(string='Sequence To Label', default='Sequence To',
                                   help="Custom label for sequence end")
    
    # Business fields
    label_destruction_date = fields.Char(string='Destruction Date Label', default='Destruction Date',
                                        help="Custom label for destruction date")
    label_record_type = fields.Char(string='Record Type Label', default='Record Type',
                                   help="Custom label for record type")
    label_confidentiality = fields.Char(string='Confidentiality Label', default='Confidentiality Level',
                                       help="Custom label for confidentiality")
    label_project_code = fields.Char(string='Project Code Label', default='Project Code',
                                    help="Custom label for project code")
    label_client_reference = fields.Char(string='Client Reference Label', default='Client Reference',
                                         help="Custom label for client reference")
    label_file_count = fields.Char(string='File Count Label', default='Number of Files',
                                  help="Custom label for file count")
    label_filing_system = fields.Char(string='Filing System Label', default='Filing System',
                                     help="Custom label for filing system")
    label_created_by_dept = fields.Char(string='Created By Dept Label', default='Created By Department',
                                       help="Custom label for creating department")
    label_authorized_by = fields.Char(string='Authorized By Label', default='Authorized By',
                                     help="Custom label for authorization")
    label_special_handling = fields.Char(string='Special Handling Label', default='Special Handling Instructions',
                                        help="Custom label for special handling")
    label_compliance_notes = fields.Char(string='Compliance Notes Label', default='Compliance Notes',
                                        help="Custom label for compliance notes")
    label_weight_estimate = fields.Char(string='Weight Estimate Label', default='Estimated Weight',
                                       help="Custom label for weight estimate")
    label_size_estimate = fields.Char(string='Size Estimate Label', default='Estimated Size',
    ...
    # COMPUTED FIELDS
    # ==========================================
    customized_label_count = fields.Integer(string='Customized Labels',
    ...
    def get_labels_for_context(self, customer_id=None, department_id=None):
        ...
        if department_id:
            dept_configs = self.search(domain + [
        ...
        # 2. Customer-specific
        if customer_id:
            customer_configs = self.search(domain + [
        ...
        global_configs = self.search(domain + [
            ('customer_id', '=', False),
            ('department_id', '=', False)
        ], order='priority desc')

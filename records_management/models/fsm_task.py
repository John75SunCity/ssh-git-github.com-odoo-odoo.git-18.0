...
class FsmTask(models.Model):
    ...
    help='Technician assigned to task'),
    ...
    help='Full address of location'),
    naid_audit_log_ids = fields.One2many('naid.audit.log', 'fsm_task_id',,
    string='NAID Audit Logs'),
    photos = fields.Many2many('ir.attachment', string='Photos',,
    help='Photos taken during task'),
    required_skills = fields.Text(string='Required Skills',,
    help='Skills required for this task'):
    required_tools = fields.Text(string='Required Tools',,
    help='Tools required for this task'):
    ...
    work_order_ids = fields.One2many('file.retrieval.work.order', 'fsm_task_id',,
    string='Work Orders'),
    ...
    view_mode = fields.Char(string='View Mode'), ('destruction', 'Destruction'), ('container_access', 'Container Access')

...
class MaintenanceRequest(models.Model):
    ...
    destruction_service_ids = fields.One2many("shredding.service", "equipment_id",,
    string="Destruction Services"),
...
class MaintenanceTeam(models.Model):
    ...
    certification_level = fields.Selection(
        [("a", "NAID A"), ("aa", "NAID AA"), ("aaa", "NAID AAA")), string="Team Certification Level",

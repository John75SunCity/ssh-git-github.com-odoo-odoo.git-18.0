...
class PortalRequest(models.Model):
    ...
    # CORE FIELDS
    # ==========================================
    name = fields.Char(string='Request Number', required=True, tracking=True,
    ...
    contact_person = fields.Many2one('res.partner', string='Requesting Contact',
    ...
    estimated_completion_date = fields.Date(string='Estimated Completion', tracking=True)
    ...
    # RELATED RECORDS
    # ==========================================
    container_id = fields.Many2one('records.container', string='Related Records Container', tracking=True)
    shredding_service_id = fields.Many2one('shred.svc', string='Related Shredding Service', tracking=True)

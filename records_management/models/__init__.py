...
# Legacy bale models removed - causing circular dependencies and not needed for fresh module
# Note: generated_model and load are also legacy bale system components (removed)

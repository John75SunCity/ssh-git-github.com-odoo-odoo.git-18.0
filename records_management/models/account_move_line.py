...
class AccountMoveLine(models.Model):
    ...
    ], string="Service Category", help="Category of service delivery")
    ...
    container_types = fields.Char(
        ...
        store=True,
        help="Types of containers involved (TYPE 01, TYPE 02, etc.)"
    )
    ...
    ], string="Rate Type", help="Type of rate applied")
    ...
    rate_unit = fields.Selection([
        ...
        ('month', 'Per Month'),
        ('trip', 'Per Trip')
    ], string="Rate Unit", help="Unit of measurement for billing rate")

...
class RecordsCustomerBillingProfile(models.Model):
    ...
    type01_storage_rate = fields.Monetary(
        string="TYPE 01 Storage Rate",
        currency_field="currency_id",
        help="Monthly rate for TYPE 01 standard boxes (1.2 CF)"
    )
    
    type02_storage_rate = fields.Monetary(
        string="TYPE 02 Storage Rate", 
        currency_field="currency_id",
        help="Monthly rate for TYPE 02 legal/banker boxes (2.4 CF)"
    )
    
    type03_storage_rate = fields.Monetary(
        string="TYPE 03 Storage Rate",
        currency_field="currency_id", 
        help="Monthly rate for TYPE 03 map boxes (0.875 CF)"
    )
    
    type04_storage_rate = fields.Monetary(
        string="TYPE 04 Storage Rate",
        currency_field="currency_id",
        help="Monthly rate for TYPE 04 odd size/temp boxes (5.0 CF)"
    )
    
    type06_storage_rate = fields.Monetary(
        string="TYPE 06 Storage Rate",
        currency_field="currency_id", 
        help="Monthly rate for TYPE 06 pathology boxes (0.042 CF)"
    )
    ...
    ], string="Payment Status", compute="_compute_payment_metrics")

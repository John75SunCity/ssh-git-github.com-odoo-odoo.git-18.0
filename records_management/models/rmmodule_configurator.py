...
class RMModuleConfigurator(models.Model):
    ...
    filter_inactive = fields.Boolean(string='Filter Inactive', default=False)
    ...
    last_user_id = fields.Many2one('last.user', string='Last User Id')
    ...
    modification_count = fields.Integer(string='Modification Count', compute='_compute_modification_count', store=True)
    numeric_value = fields.Char(string='Numeric Value')
    performance_impact = fields.Char(string='Performance Impact')
    related_configs_count = fields.Integer(string='Related Configs Count', compute='_compute_related_configs_count', store=True)

...
class MaintenanceRequest(models.Model):
    ...
    request_date = fields.Datetime(
        ...
        required=True,
        tracking=True,
        help="Date when the maintenance request was created",
    )
    ...
    def _compute_total_cost(self):
        ...
        for request in self:
            request.cost = (
                request.labor_cost + request.parts_cost + request.external_cost
            )
                ...
                (
                    ...
                    0,
                    {
                        "name": _(
                            ...
                            self.equipment_id.name or self.name,
                        ),
                        "quantity": 1,
    ...
    def get_maintenance_costs_report(self, date_from=None, date_to=None):
        ...
        return {
            ...
            "requests_data": requests.read(
                ["name", "cost", "request_date", "equipment_id"]
            ),
        }

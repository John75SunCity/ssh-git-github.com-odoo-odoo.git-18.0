...
class ProductTemplate(models.Model):
    ...
    ], string="Template Category", help="Category of the service template")
    ...
    base_cost = fields.Float(
        string="Base Cost",
        help="Base cost for the service"
    )
    ...
    shredding_included = fields.Boolean(
        string="Shredding Included",
        default=False,
        help="Shredding service is included"
    )
    ...
    first_sale_date = fields.Date(
        string="First Sale Date",
        help="Date of the first sale of this product"
    )
    last_sale_date = fields.Date(
        string="Last Sale Date", 
        help="Date of the most recent sale"
    )
    ...
    expiry_date = fields.Date(
        string="Expiry Date",
        help="Date when this product expires or is discontinued"
    )
    ...
    period = fields.Selection([
        ...
        ('quarterly', 'Quarterly'),
        ('annually', 'Annually'),
    ], string="Service Period", default='monthly')

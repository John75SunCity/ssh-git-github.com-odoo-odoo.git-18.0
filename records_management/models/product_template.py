...
Key Features
- Container type specifications (TYPE 1-6) with actual business dimensions
...
class ProductTemplate(models.Model):
    ...
    # ============================================================================
    additional_box_cost = fields.Monetary(string='Additional Box Cost', currency_field='currency_id',,
    help='Cost for additional boxes beyond included amount'):
    additional_document_cost = fields.Monetary(string='Additional Document Cost', currency_field='currency_id',,
    help='Cost for additional documents beyond included amount'):
    auto_invoice = fields.Boolean(string='Auto Invoice',,
    help='Automatically generate invoices for this service'):
    average_sale_price = fields.Monetary(string='Average Sale Price', currency_field='currency_id',,
    compute='_compute_average_sale_price'),
    base_cost = fields.Monetary(string='Base Cost', currency_field='currency_id',,
    help='Base cost before markups'),
    ...
    help='24/7 emergency retrieval available'),
    first_sale_date = fields.Date(string='First Sale Date',,
    help='First time this service was sold'),
    ...
    help='Overhead component of cost'),
    pickup_delivery_included = fields.Boolean(string='Pickup/Delivery Included',,
    help='Includes pickup and delivery service'),
    ...
    digits=(8, 2), help='Rate of sales over time')
    same_day_service = fields.Boolean(string='Same Day Service',,
    help='Same day service available'),
    ...
    help='Secure shredding included'),
    sla_terms = fields.Text(string='SLA Terms',,
    help='Service level agreement terms'),
    ...
    total_revenue_ytd = fields.Monetary(string='Total Revenue YTD', currency_field='currency_id',,
    compute='_compute_total_revenue_ytd'),
    total_sales_ytd = fields.Integer(string='Total Sales YTD',,
    compute='_compute_total_sales_ytd'),
    ...
    help='Customer can witness destruction')

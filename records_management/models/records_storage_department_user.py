...
"
    _description = "records.storage.department.user"
...
""
    ...
    history_ids = fields.One2many('history', 'records_storage_department_user_id',,
    string='History Ids'),
    ...
    view_ids = fields.One2many('view', 'records_storage_department_user_id',,""
    string='View Ids'),""

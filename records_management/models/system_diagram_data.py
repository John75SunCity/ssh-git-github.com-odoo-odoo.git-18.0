...
class GeneratedModel(models.Model):
    ...
    generation_time = fields.Float(string='Generation Time (seconds)')
    node_spacing = fields.Integer(string='Node Spacing')
    edge_length = fields.Integer(string='Edge Length')
    layout_algorithm = fields.Selection(string='Layout Algorithm')
    include_inactive = fields.Boolean(string='Include Inactive')
    group_by_module = fields.Boolean(string='Group By Module')
    max_depth = fields.Integer(string='Maximum Depth')
    exclude_system_models = fields.Boolean(string='Exclude System Models')

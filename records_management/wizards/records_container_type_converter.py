...
class RecordsContainerTypeConverter(models.TransientModel):
    ...
    container_ids = fields.Many2many(
        "records.container", string="Containers to Convert"
    )
    ...
    to_type = fields.Selection(
        ...
        string="To Container Type",
        required=True,
    )
    reason = fields.Text(string="Reason for Conversion", required=True)
    update_billing = fields.Boolean(
        string="Update Billing Rates",
        default=True,

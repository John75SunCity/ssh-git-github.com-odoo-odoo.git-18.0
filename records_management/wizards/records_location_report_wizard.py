...
class RecordsLocationReportWizard(models.TransientModel):
    ...
    user_id = fields.Many2one(comodel_name='res.users', string='Generated By', default=lambda self: self.env.user)
    location_id = fields.Many2one(comodel_name='records.location', string='Location', required=True)
    include_child_locations = fields.Boolean(string='Include Child Locations')
    specific_location_ids = fields.Many2many(
        'records.location',
        relation='records_location_report_wizard_location_rel',
        column1='wizard_id',
        column2='location_id',
        string='Specific Locations'
    )
    ...
    specific_customer_ids = fields.Many2many(
        'res.partner',
        relation='records_location_report_wizard_customer_rel',
        column1='wizard_id',
        column2='partner_id',

...
class WorkOrderBinAssignmentWizard(models.TransientModel):
    ...
    customer_id = fields.Many2one('res.partner', string='Customer', 
                                 related='work_order_id.customer_id', readonly=True)
    ...
    department_ids = fields.Many2many('records.department', string='Filter by Departments')
    ...
    ], string='Bin State Filter', default='stored')
    ...
    # STATISTICS
    # ==========================================
    total_available = fields.Integer(string='Total Available', compute='_compute_statistics')
    total_selected = fields.Integer(string='Total Selected', compute='_compute_statistics')
    estimated_weight = fields.Float(string='Estimated Weight', compute='_compute_statistics')
    estimated_volume = fields.Float(string='Estimated Volume', compute='_compute_statistics')
    ...
    @api.onchange('assignment_type', 'location_ids', 'department_ids', 'bin_state', 'date_from', 'date_to')

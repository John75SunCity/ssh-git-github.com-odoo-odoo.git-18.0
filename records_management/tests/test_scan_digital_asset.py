"""
Test cases for the scan.digital.asset model in the records management module.
...
class TestScanRetrievalWorkOrder(TransactionCase):
    """Test cases for scan.digital.asset model"""
    ...
    def _create_test_record(self, **kwargs):
        ...
        return self.env['scan.digital.asset'].create(default_values)
    ...
    def test_unlink_record(self):
        ...
        record_id = record.id
        record.unlink()
        self.assertFalse(self.env['scan.digital.asset'].browse(record_id).exists())
    ...
    def test_bulk_operations(self):
        ...
        # Test bulk create
        bulk_records = self.env['scan.digital.asset'].create(records)

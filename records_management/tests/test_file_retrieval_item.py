...
class TestScanRetrievalItem(TransactionCase):
    """Test cases for file.retrieval.item model"""
    ...
    def test_unlink_record(self):
        ...
        record_id = record.id
        record.unlink()
        self.assertFalse(self.env['file.retrieval.item'].browse(record_id).exists())
    ...
    def test_bulk_operations(self):
        ...
        # Test bulk create
        bulk_records = self.env['file.retrieval.item'].create(records)

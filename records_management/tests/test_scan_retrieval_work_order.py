"""
Test cases for the scan.retrieval.work.order model in the records management module.
...
class TestScanRetrievalItem(TransactionCase):
    """Test cases for scan.retrieval.work.order model"""
    ...
    def _create_test_record(self, **kwargs):
        ...
        return self.env['scan.retrieval.work.order'].create(default_values)
    ...
    def test_unlink_record(self):
        ...
        record_id = record.id
        record.unlink()
        self.assertFalse(self.env['scan.retrieval.work.order'].browse(record_id).exists())
    ...
    def test_bulk_operations(self):
        ...
        # Test bulk create
        bulk_records = self.env['scan.retrieval.work.order'].create(records)

"""
Test cases for the stock.move model in the records management module.
...
class TestStockMoveSMSValidation(TransactionCase):
    ...
    def _create_test_record(self, **kwargs):
        ...
        return self.env['stock.move'].create(default_values)
    ...
    def test_create_record(self):
        ...
        self.assertEqual(record._name, 'stock.move')
    ...
    def test_unlink_record(self):
        ...
        record_id = record.id
        record.unlink()
        self.assertFalse(self.env['stock.move'].browse(record_id).exists())
    ...
    def test_bulk_operations(self):
        ...
        # Test bulk create
        bulk_records = self.env['stock.move'].create(records)

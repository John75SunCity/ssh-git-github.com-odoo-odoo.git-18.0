...
def fix_mail_thread_fields():
    ...
    for file_path in model_files:
        ...
        try:
            ...
            if '_inherit = ["mail.thread"' not in content and '_inherit = [\'mail.thread\'' not in content:
                continue
            ...
            content = re.sub(compute_pattern, r'\1# Mail framework fields provided by mail.thread inheritance\n', content, flags=re.MULTILINE | re.DOTALL)
...
if __name__ == "__main__":
    ...
    fixed_files = fix_mail_thread_fields()

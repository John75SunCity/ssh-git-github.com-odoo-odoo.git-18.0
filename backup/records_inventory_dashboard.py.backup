...
class RecordsInventoryDashboard(models.Model):
    ...
    type01_count = fields.Integer(
        string='TYPE 01 Count',
        compute='_compute_container_type_breakdown',
        help='Count of TYPE 01 standard boxes'
    
    
    type02_count = fields.Integer(
        string='TYPE 02 Count',
        compute='_compute_container_type_breakdown',
        help='Count of TYPE 02 legal/banker boxes'
    
    
    type03_count = fields.Integer(
        string='TYPE 03 Count',
        compute='_compute_container_type_breakdown',
        help='Count of TYPE 03 map boxes'
    
    
    type04_count = fields.Integer(
        string='TYPE 04 Count',
        compute='_compute_container_type_breakdown',
        help='Count of TYPE 04 odd size/temp boxes'
    
    
    type06_count = fields.Integer(
        string='TYPE 06 Count',
        compute='_compute_container_type_breakdown',
        help='Count of TYPE 06 pathology boxes'
    ...
    def get_container_type_distribution(self):
        ...
        self.ensure_one()
        return {}
            'TYPE 01 (Standard)': self.type01_count,
            'TYPE 02 (Legal/Banker)': self.type02_count,
            'TYPE 03 (Map)': self.type03_count,
            'TYPE 04 (Odd Size/Temp)': self.type04_count,
            'TYPE 06 (Pathology)': self.type06_count,

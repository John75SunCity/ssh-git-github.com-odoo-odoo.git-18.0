...
class APIDependsFixer:
    ...
    def add_api_depends_to_method(self, file_content, method_name, dependencies):
        ...
        new_content = (
            file_content[:method_start] + decorator + file_content[method_start:]
        )
        ...
        try:
            ...
            for method_name in compute_methods:
                ...
                if method_match:
                    ...
                    dependencies = self.analyze_compute_method(
                    ...
                    if fixed:
                        ...
                        print(
                            f"   ✅ {method_name}: {deps_preview}{'...' if len(dependencies) > 3 else ''}"
                        )
    ...
    def run_comprehensive_fix(self):
        ...
        print(
            f"📈 Performance improvement: Eliminated unnecessary compute recalculations"
        )
